  ...
  <form method="post" action="./api/edit.php">
    <table width="100%">
      <tbody>
        ...
        <tr class="cent">
          <td>
            <embed src="./img/<?=$r['file'];?>" style="width:120px;height:90px"></embed>
          </td>
          <td>
          ...
          <td>
            ...
            <input type="button" value="更換動畫" onclick="op('#cover','#cvr','./view/update_<?=$useTable;?>.php?id=<?=$r['id'];?>&table=<?=$useTable;?>')" >
