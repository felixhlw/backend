...
(3, '02B03.jpg', '王宏禮', '2019-12-20', '0932281027', '台北市', 'felixhlw@gmail.com', '個性開朗，認真負責及細心，自我要求高，熟悉團隊合作，樂於助人及擅於工作協調溝通，曾專職負責包括Disney、Warner Brother. Universal 等客戶之製作技術溝通與進度協調等工作項目。本身所學具備高度專業美術敏感度及執行力，在美術編輯、設計及電腦動畫產業超過25年工作經驗，工作項目包括美術設計、繪畫、插畫及動畫影片製作、後製特效製作及影片剪輯、電腦系統規劃、架設及管理、人員教育訓練、專案規劃及管理等。', 1),
