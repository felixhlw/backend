...
(3, '02B03.jpg', '王宏禮 Felix Wang', '2019-12-20', '0932281027', '台北市 TW', 'felixhlw@gmail.com', '個性開朗及溫和有禮，認真負責及細心，自我要求高，熟悉團隊合作，樂於助人及擅於工作協調溝通，曾專職負責包括Disney、Warner Brother. Universal 等客戶之製作技術溝通與進度協調等工作項目。本身所學具備高度專業美術敏感度及執行力，在美術編輯、設計及電腦動畫產業超過25年工作經驗，工作項目包括美術設計、繪畫、插畫及動畫影片製作、後製特效製作及影片剪輯、電腦系統規劃、架設及管理、人員教育訓練、專案規劃及管理等。\r\n\r\n<br><i class=\'far fa-file\'></i> 個人履歷:\r\n<a href=https://www.cakeresume.com/felixhlw style=color:red target=_blank>\r\nhttps://www.cakeresume.com/felixhlw\r\n</a>', 1),
...
(2, 'head.jpg', 'Felix Wang', '嗨! 我是菲力，專長: 美術設計、影音動畫編輯以及網頁、程式等製作。同時本身還是擁有合格證照的專業保母喔! 歡迎來到我的個人資訊網站!\r\n\r\n', 1),
(4, 'page-0003-1.jpg', '', '', 0);
